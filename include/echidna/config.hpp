...
namespace coypu
{
    namespace config
    {
        ...
        public:
            ...
            bool GetKeyValue(const std::string &key, std::string &out)
            {
            ...
            template <typename T>
            bool GetValue(const std::string &key, T &out)
            {
                auto i = _maps.find(key);
                if (i != _maps.end())
                {
            ...
            template <typename T>
            bool GetValue(const std::string &key, T &out, const T &defaultValue)
            {
                auto i = _maps.find(key);
                if (i != _maps.end())
                {
